...
<head>
  ...
  <title>21Twelve Dashboard</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      @can('isAdmin')
        <li class="nav-item {{ url()->current() == url('roles') ? 'active' : '' }}">
      ...
      @canany(['isAdmin','isManager'])
        ...
        <li class="nav-item {{ url()->current() == url('transactions') ? 'active' : '' }}">
          <a class="nav-link" href="/transactions">
            <i class="fas fa-fw fa-credit-card"></i>
            <span>Transactions</span></a>
        </li>
      @endcanany
      @canany(['isAdmin','isManager','isContentEditor'])
        <li class="nav-item {{ url()->current() == url('posts') ? 'active' : '' }}">
